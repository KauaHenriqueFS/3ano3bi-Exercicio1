...
public class DAOJPA {
    ...
    public List<Func> listarTodos() throws Exception {
        BancoJPA bb;
        List<Func> lista;
        try {
            bb = new BancoJPA();
            lista = bb.sessao.createNamedQuery("Func.findAll", Func.class).getResultList();
            BancoJPA.conexao.close();
            return lista;
        } catch (Exception ex) {
...
/*
    public List<Func> listarTodosSemCache() throws Exception {
        BancoJPA bb;
        Query consulta;
        List<Func> lista;
        try {
            bb = new BancoJPA();
            consulta = bb.sessao.createNamedQuery("Func.findAll", Func.class);
    ...
    public List<Func> listar() throws Exception {
        BancoJPA bb;
        List<Func> lista;
        try {
            bb = new BancoJPA();
            lista = bb.sessao.createQuery("select a from Func a order by a.nome")
                    .getResultList();
            BancoJPA.conexao.close();
            return lista;
        } catch (Exception ex) {
    ...
    public List<Func> listarSemCache() throws Exception {
        BancoJPA bb;
        List<Func> lista;
        try {
            bb = new BancoJPA();
    ...
    public List<Nota> listarNotas(int codigo) throws Exception {
        ...
        try {
            bb = new BancoJPA();
            lista = bb.sessao.createQuery("SELECT n FROM Nota n where n.codFunc.codigo = :cod")
    ...
    public List<Object> listaMedia() throws Exception {
        ...
        try {
            bb = new BancoJPA();
            lista = bb.sessao.createQuery("SELECT a.nome, avg(n.valor) FROM Nota n inner join n.codFunc a group by a.codigo,a.nome")
                    .getResultList();
            BancoJPA.conexao.close();
            return lista;
        } catch (Exception ex) {
    ...
    public List<Object> listaFuncMaiorNota() throws Exception {
        BancoJPA bb;
        List<Object> lista;
        try {
            bb = new BancoJPA();
            lista = bb.sessao.createQuery("select distinct a.nome, n.valor from Nota n inner join n.codFunc a "
